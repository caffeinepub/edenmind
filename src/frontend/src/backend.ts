...
export class Backend implements backendInterface {
    ...
    async getAllDiagnoses(): Promise<Array<Diagnosis>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDiagnoses();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getDiagnosis(): Promise<Diagnosis> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiagnosis();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchDiagnosesByIssue(arg0: string): Promise<Array<Diagnosis>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchDiagnosesByIssue(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPlantInfo(arg0: PlantInfo): Promise<Diagnosis> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPlantInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
